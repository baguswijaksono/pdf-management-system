...
<body>
    ...
    <form class="row g-3 needs-validation" novalidate action="{{route('book.edit.save')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-12">
            ...
            <select id="category" name="category" class="form-select" aria-label="Default select example">
                ...
                @if ($category->name == $data->category->name)
                @else
        ...
        <div class="col">
            <div class="form-floating">
                <textarea class="form-control" placeholder="Add synopsis here" name="description" id="description">{{$data->description}}</textarea>
        ...
        <div class="col-md-12">
            <label for="image" class="form-label">Image (Masukan jika ingin dirubah)</label>
            <input class="form-control" type="file" name="image" accept=".jpeg, .jpg, .png">
        </div>
        

        <div class="col-md-12">
            <label for="pdf" class="form-label">PDF (Masukan jika ingin dirubah)</label>
