...
<html lang="en">
  ...
  <body>
    ...
    <center>
      ...
      <a class="btn btn-primary" href="{{ route('category.add') }}">Tambah Kategori</a>
  </center>
    ...
    <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
            ...
            @php
            $count = App\Models\Books::where('userId', Auth::user()->id)
            ...
            <tr>
                ...
                @else
                <td><a class="btn btn-dark" href="{{ route('category.specify', ['category' => $category->name]) }}">Details</a></td>
                @endif
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                 Kategori {{ $category->name }} akan dihapus termasuk semua buku yang memiliki kategori ini akan dihapus, anda yakin ?
                            </div>
